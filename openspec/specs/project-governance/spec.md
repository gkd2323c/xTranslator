...
Keep the repository's spec and documentation surfaces trustworthy so future changes can rely on strict validation, accurate feature claims, and stable test expectations.
